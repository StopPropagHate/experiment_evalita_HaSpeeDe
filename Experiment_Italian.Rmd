...
#Task 1 - fb
task1_fb_res <- read.table(file = 'paper_submited_files/haspeede_StopPropagHate_Task1_HaSpeeDe-FB.tsv',
                           sep = '\t', 
                           header = FALSE)
task1_fb_res <- cbind(dataset_hs_FB_test, task1_fb_res)
write.table(task1_fb_res, 
            file='paper_submited_files/haspeede_StopPropagHate_Task1_HaSpeeDe-FB_2.tsv', 
            quote=FALSE, sep='\t', 
            col.names = FALSE, 
            row.names = FALSE)

#Task 1 - mix
task1_fb_mix_res <- read.table(file = 'paper_submited_files/haspeede_StopPropagHate_Task1_HaSpeeDe-FB_mix_model.tsv',
                           sep = '\t', 
                           header = FALSE)
task1_fb_mix_res <- cbind(dataset_hs_FB_test, task1_fb_mix_res)
write.table(task1_fb_mix_res, 
            file='paper_submited_files/haspeede_StopPropagHate_Task1_HaSpeeDe-FB_mix_model_2.tsv', 
            quote=FALSE, sep='\t', 
            col.names = FALSE, 
            row.names = FALSE)
#Task 2
task2_tw_res <- read.table(file = 'paper_submited_files/haspeede_StopPropagHate_Task2_HaSpeeDe-TW.tsv',
                           sep = '\t', 
                           header = FALSE)
task2_tw_res <- cbind(dataset_hs_TW_test, task2_tw_res)
write.table(task2_tw_res, 
            file='paper_submited_files/haspeede_StopPropagHate_Task2_HaSpeeDe-TW_2.tsv', 
            quote=FALSE, sep='\t', 
            col.names = FALSE, 
            row.names = FALSE)

#Task 2 mix
task2_tw_mix_res <- read.table(file = 'paper_submited_files/haspeede_StopPropagHate_Task2_HaSpeeDe-TW_mix_model.tsv',
                           sep = '\t', 
                           header = FALSE)
task2_tw_mix_res <- cbind(dataset_hs_TW_test, task2_tw_mix_res)
write.table(task2_tw_mix_res, 
            file='paper_submited_files/haspeede_StopPropagHate_Task2_HaSpeeDe-TW_mix_model_2.tsv', 
            quote=FALSE, sep='\t', 
            col.names = FALSE, 
            row.names = FALSE)

#Task 3.1
task3.1 <- read.table(file = 'paper_submited_files/haspeede_StopPropagHate_Task3.1_Cross-HaSpeeDe_FB.tsv',
                           sep = '\t', 
                           header = FALSE)
task3.1 <- cbind(dataset_hs_TW_test, task3.1)
write.table(task3.1, 
            file='paper_submited_files/haspeede_StopPropagHate_Task3.1_Cross-HaSpeeDe_FB_2.tsv', 
            quote=FALSE, sep='\t', 
            col.names = FALSE, 
            row.names = FALSE)
...
task3.2 <- read.table(file = 'paper_submited_files/haspeede_StopPropagHate_Task3.2_Cross-HaSpeeDe_TW.tsv',
                           sep = '\t', 
                           header = FALSE)
task3.2 <- cbind(dataset_hs_FB_test, task3.2)
write.table(task3.2, 
            file='paper_submited_files/haspeede_StopPropagHate_Task3.2_Cross-HaSpeeDe_TW_2.tsv', 
            quote=FALSE, sep='\t', 
            col.names = FALSE, 
            row.names = FALSE)
